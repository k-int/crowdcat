...
'''
  ...
  public static annotations_context = '''
      ...
      if ( request.method=='POST' ) {
        ...
        if ( params.uri && ( params.uri.trim().length() > 0 ) ) {
          ...
          while (results.hasNext()) {
            ...
            // Method 2 -- lets try setting the context in the stand alone model
            // https://jena.apache.org/documentation/javadoc/jena/org/apache/jena/rdf/model/ResourceFactory.html
            // org.apache.jena.rdf.model.Statement ctx_stmnt = 
            //    org.apache.jena.rdf.model.ResourceFactory.createStatement(stand_alone_model.getResource('_:b1'),
            //                                                              org.apache.jena.rdf.model.ResourceFactory.createProperty('@context'),
            //                                                              org.apache.jena.rdf.model.ResourceFactory.createPlainLiteral('http://iiif.io/api/presentation/2/context.json'))
            // stand_alone_model.add(ctx_stmnt);

            // This works, but has no context
            // org.apache.jena.riot.RDFDataMgr.write(System.out, stand_alone_model, Lang.JSONLD);
  
            log.debug("As JSONLD");
            // org.apache.jena.riot.JsonLDWriteContext context = new org.apache.jena.riot.JsonLDWriteContext()
            // context.setJsonLDContext('http://iiif.io/api/presentation/2/context.json');
            StringWriter ld_sw = new StringWriter()
            // org.apache.jena.riot.WriterDatasetRIOT json_ld_writer = org.apache.jena.riot.RDFDataMgr.createDatasetWriter(Lang.JSONLD)
            ...
            // json_ld_writer.write(ld_sw, stand_alone_model, new org.apache.jena.riot.system.PrefixMapStd(), '', context) 
            WriterDatasetRIOT w = RDFDataMgr.createDatasetWriter(Lang.JSONLD)
            // org.apache.jena.sparql.util.Context c = RIOT.getContext().copy();
